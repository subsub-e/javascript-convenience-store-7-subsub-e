...
class OutputView {
  ...
  static showReceipt(receipt) {
    ...
    this.printReceiptHeader(totalPurchasePriceLength);
  ...
  static printPurchaseItem(item, totalPurchasePriceLength) {
    ...
    const itemQuantity = item.quantity
      .toString()
      .padEnd(15 - totalPurchasePriceLength, ' ');
